...
class EnemyMech:
    def __init__(self,tier,archetype,actions,core,lSh,rSh,lArm,rArm,coreA,coreB,chestA,chestB,chestC,chestD,lLeg,rLeg,allyFlag):
        self.coverBonus=0
        self.maxHP=500
        self.ac=4
        self.tier=tier
    ...
    def opis(self, extended=False):
        ...
        if extended:
            tekst+=", Core: {}, HP: {}, AC (base): {}".format(self.core.ime, self.maxHP, self.ac)
        return tekst
    ...
    def showDetails(self, parent):
        ...
        archetxt = "Mech archetype: {}".format(self.archetype)
        ...
        move = Label(actionFrame, text="Player Mechs have 1 of each of the different action types its' pilot has.",
    ...
    def editLoadout(self, parent, grandParent):
        ...
        rShPH = StringVar(parent, self.rSh.ime if isinstance(self.rSh, (MechWeapon,Module)) else self.rSh if isinstance(self.rSh, str) else None)
        ...
        lShPH = StringVar(parent, self.lSh.ime if isinstance(self.lSh, (MechWeapon,Module)) else self.lSh if isinstance(self.lSh, str) else None)
        ...
        body1PH = StringVar(parent, self.chestA.ime if isinstance(self.chestA, (MechWeapon,Module)) else self.chestA if isinstance(self.chestA, str) else None)
        ...
        body2PH = StringVar(parent, self.chestB.ime if isinstance(self.chestB, (MechWeapon,Module)) else self.chestB if isinstance(self.chestB, str) else None)
        ...
        body3PH = StringVar(parent, self.chestC.ime if isinstance(self.chestC, (MechWeapon,Module)) else self.chestC if isinstance(self.chestC, str) else None)
        ...
        body4PH = StringVar(parent, self.chestD.ime if isinstance(self.chestD, (MechWeapon,Module)) else self.chestD if isinstance(self.chestD, str) else None)
        ...
        rLegPH = StringVar(parent, self.rLeg.ime if isinstance(self.rLeg, (MechWeapon,Module)) else self.rLeg if isinstance(self.rLeg, str) else None)
        ...
        lLegPH = StringVar(parent, self.lLeg.ime if isinstance(self.lLeg, (MechWeapon,Module)) else self.lLeg if isinstance(self.lLeg, str) else None)
    ...
    def delete(self):
        try:
            podatci.ENEMY_MECHS.remove(self)
        except ValueError:
